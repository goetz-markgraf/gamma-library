...
class OperatorCall(
    ...
    override fun prettyPrint(): String {
        val levelOp1 = op1 is OperatorCall && op1.level > level
        val levelOp2 = op2 is OperatorCall && op2.level > level
    ...
    companion object {
        fun build(operator: Identifier, op1: Value, op2: Value) =
            OperatorCall(builtInSource, nullPos, nullPos, operator, op1, op2)
    }
}
